...
\section{Section 2}
{
\sectionheaderGold %Enclose the frame with {} and add this command for skin background in section header
...
\section{Section 3}
{
\sectionheaderGrey %Enclose the frame with {} and add this command for green background in section header
