...
\setsansfont[Path=fonts/,
    ...
    ItalicFont    =SERII___.TTF]{SERIRG__.TTF}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\section{Test}
\begin{frame}{Test}
%    \LARGE{(SEROriginal: Type your content here.)}

%   \setmainfont{Calibri}
%   \LARGE{(Calibri: Type your content here.)}

    \setsansfont[Path=fonts/]{SERIRG__.TTF}
    (SERIRG: Type your content here.)

    \setsansfont[Path=fonts/]{SERIB___.TTF}
    (SERIB: Type your content here.)

    \setsansfont[Path=fonts/]{SERIBC__.TTF}
    (SERIBC: Type your content here.)

    \setsansfont[Path=fonts/]{SERII___.TTF}
    (SERII: Type your content here.)

    \setsansfont[Path=fonts/]{SERILRG_.TTF}
    (SERILRG: Type your content here.)

    \setsansfont[Path=fonts/]{SERILB__.TTF}
    (SERILB: Type your content here.)
  
    \setsansfont[Path=fonts/]{SERILI__.TTF}
    (SERILI: Type your content here.)

    \setsansfont[Path=fonts/]{SERILBI_.TTF}
    (SERILBI: Type your content here.)

    Blablabla \textbf{blablabla} \textit{blablabla} \texttt{blablabla}

    \setsansfont[Path=fonts/,
        BoldFont      =SERILB__.TTF,
        ItalicFont    =SERILI__.TTF]{SERILRG_.TTF}
